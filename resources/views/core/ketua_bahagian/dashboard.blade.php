...
@section('content') 
    ...
    @component('layouts.headers.breadcrumbs')
        ...
        <li class="breadcrumb-item"><a href="{{ route('ketua-bahagian-dashboard.index') }}">{{ __('Dashboards') }}</a></li>
        <li class="breadcrumb-item active" aria-current="page">{{ __('Default') }}</li>
    @endcomponent

    <h1><strong class="text-white">Selamat Datang Ke Modul Ketua Bahagian</strong></h1>
