...
class DashboardCardsKakitanganComposer
{
    ...
    {  
        ...
        $jumlahTuntutanKerjaLebihMasaKT = permohonan_with_users::select('CUSTOMERID')
                                            ->where('CUSTOMERID', Auth::id())
                                            ->get()
                                            ->count();
        $jumlahTuntutanTahunSemasaKT = permohonan_with_users::select('CUSTOMERID')
                                            ->where('CUSTOMERID', Auth::id())
