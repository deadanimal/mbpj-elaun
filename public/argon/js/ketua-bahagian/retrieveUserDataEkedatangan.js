function retrieveUserData(id_user, id_permohonan_baru, jenisPermohonan) {
    ...
    $.ajax({
        url: 'ketua-bahagian-semakan/semakan-pekerja/' + id_user,
        type: 'GET',
    ...
    $.ajax({
        url: 'ketua-bahagian-semakan/semakan-permohonan/' + id_permohonan_baru,
        type: 'GET',
        success: function(data) {
...
function fillInSenaraiKakitangan(senaraiKakitangan, jenisPermohonan) {
    ...
    senaraiKakitangan.forEach(element => {
        $(document).ready(function(){
            $.ajax({
                url: 'ketua-bahagian-semakan/semakan-pekerja/' + element,
                type: 'GET',
                success: function(data) {
...
function fillInKedatangan(idKakitangan, jenisPermohonan) {    
    $.ajax({
        url: 'ketua-bahagian-semakan/semakan-ekedatangan/' + idKakitangan,
        type: 'GET',
        success: function(data) {
