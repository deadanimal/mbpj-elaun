...
function showDatatable(){
    var id_user = $('#userID').val()
                var dashboardKBDT = $('#dashboardKBDT').DataTable({
                dom: 'lrtip',
                destroy: true,
        ...
        dashboardKBDT.on('draw.dt', function () {
            var info = dashboardKBDT.page.info();
            dashboardKBDT.column(0, { search: 'applied', order: 'applied', page: 'applied' }).nodes().each(function (cell, i) {
